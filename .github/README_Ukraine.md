...
#### Тобі потрібна допомога? Напиши мені на: developer.mishakorzhik@gmail.com
...
### Помилка? Якщо інструмент виходить з ладу, виконайте такі дії: 
   ...
   1. Зробіть знімок екрана і перевірте 
   помилку детально 
...
```
 ...
 Desing:
  Виправлено 3 бага
  Додано Було нову кастомізацію
  Додано кастомізацює загрузки
