...
print("  \033[1;34m[ 01 ] >> \033[1;36;40mZphisher - An automated phishing tool with 30+ templates")
print("  \033[1;34m[ 02 ] >> \033[1;36;40mShellphish - Modded version of shellphish")
print("  \033[1;34m[ 03 ] >> \033[1;36;40mSayCheese - Grab target's webcam shots by link")
print("  \033[1;34m[ 04 ] >> \033[1;36;40mBlackPhish - It's easy phishing tool")
print("  \033[1;34m[ 05 ] >> \033[1;36;40mUserRecon - find people from social")
print("  \033[1;34m[ 06 ] >> \033[1;36;40mMask Phish - An masking phishing url")
print("  \033[1;34m[ 07 ] >> \033[1;36;40mSeeker - Accurately Locate Smartphones")
print("  \033[1;34m[ 08 ] >> \033[1;36;40mAIOPhish - A Social Toolkit for phishing")
print("  \033[1;34m[ 09 ] >> \033[1;36;40mISeeYou - Find the exact location of the users")
print("  \033[1;34m[ 10 ] >> \033[1;36;40mBlackEye - The ultimate phishing tool with 38 websites available!")
print("  \033[1;34m[ 11 ] >> \033[1;36;40mNPhish - Phishing Tool with 60+ Phishing Sites")
print("  \033[1;34m[ 12 ] >> \033[1;36;40mExit System - log out AllHackingTools")
...
if(op==1):
 ...
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd blackeye && bash blackeye.sh && cd && cd AllHackingTools && python2 MainMenu.py")
elif(op==11):
 os.system("clear")
 os.system("NPhish")
elif(op==12):
